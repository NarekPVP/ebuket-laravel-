                        ...
                        <div class="contacts-container grid bottom-tier">
                            <div class="contacts-form-main-wrapper">
                                ...
                                <div class="new-card">
                                    ...
                                    <form class="new-flower" method="POST" action="{{ route('price.edit.post', [app()->getLocale(), $price]) }}">
                                        @csrf
                                        ...
                                        <div class="flex">
                                            <div class="req-div w-50">
                                                ...
                                                <input class="form-input required-input flower-list" type="text" placeholder="Назва товару" name="name" value="{{ $price->name }}">
                                                @error('name')
                                            ...
                                            <div class="req-div w-50">
                                                ...
                                                <input class="form-input required-input" type="color" placeholder="Назва товару" name="color" value="{{ $price->color }}">
                                                @error('color')
                                                <div class="alert alert-danger" role="alert">
                                                    {{ $message }}
                                                </div>
                                            ...
                                            <div class="req-div">
                                                ...
                                                <input class="form-input required-input" type="text" placeholder="Цена" name="amount" value="{{ $price->amount }}">
                                                @error('amount')
                                                <div class="alert alert-danger" role="alert">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="flex align-center">
                                            <div class="checkbox-div flex w-50">
                                                ...
                                                <div class="req-div">
                                                    ...
                                                    <input class="form-input required-input" type="text" placeholder="Высота" name="height" value="{{ $price->height }}">
                                                </div>
                                            </div>
                                            <div class="checkbox-div flex w-50 relative">
                                                ...
                                                <div class="select select-parent relative special-marg">
                                                    ...
                                                    <button class="btn main-btn select-btn main-gray before-chevron" type="button" id="country" data-bs-toggle="dropdown">{{ $price->made_in }}</button>
                                        ...
                                        <div class="req-div">
                                            ...
                                            <input class="form-input required-input" type="text" placeholder="Сорт" name="sort" value="{{ $price->sort }}">
                                        </div>
                                        <div class="req-div">
                                            <span class="req-span">
                                                *Обов'язкове поле
                                            </span>
                                            <input class="form-input required-input" type="text" placeholder="Коментарій" name="comment" value="{{ $price->comment }}">
                                        </div>
                                        <button class="main-btn main-blue m-10" type="submit">Оновити</button>
                                    </form>
                                </div>
                            </div>
                        </div>
